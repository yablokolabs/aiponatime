      ...
      <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            <h3 className="text-white text-4xl font-bold leading-9 mb-4 lg:mb-10">
              AIponATime<sup className="text-sm">™</sup>
            </h3>
            <p className="text-white/70 text-lg mb-6 max-w-xs">
              Creating magical, personalized storybooks that inspire a love for reading in every child.
            </p>
            <div className="flex gap-4">
              ...
              <Link
                href="https://www.facebook.com/people/aiponatime/61578219777424"
                className="footer-icons hover:bg-primary transition-colors duration-200 p-2 rounded-full"
              >
                <Image
              ...
              <Link
                href="https://www.instagram.com/aiponatime"
                className="footer-icons hover:bg-primary transition-colors duration-200 p-2 rounded-full"
              >
                <Image
