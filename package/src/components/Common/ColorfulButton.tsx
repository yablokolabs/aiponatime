...
export const ColorfulButton = ({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClick}
        className={`relative bg-gradient-to-r ${gradientFrom} ${gradientTo} text-white font-semibold rounded-full ${sizeClasses[size]} hover:shadow-lg transform transition-all duration-200 flex items-center`}
      >
        {children}
