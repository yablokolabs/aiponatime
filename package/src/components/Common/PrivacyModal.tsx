      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-4xl max-h-[90vh] overflow-y-auto rounded-lg bg-white p-6 relative">
          ...
          <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto text-gray-700">
            ...
            <p className="mb-4">
              At AIponATime™, we respect your privacy and are committed to protecting your personal information. This
              Privacy Policy outlines what data we collect, how we use it, and how we keep it safe when you use our
              website and AI storytelling services.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                ...
                Your name, email address, and any details you provide when creating an account or making a purchase.
              </li>
              <li>
                <strong>Child's Details:</strong>{" "}
                Name, age, and interests provided by you for generating personalized stories.
              </li>
              <li>
                <strong>Usage Data:</strong> Website analytics, cookies, and similar tracking to improve our service.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Data may be shared only with trusted third-party tools and partners essential to our platform (e.g.,
            ...
            <p>
              We use standard security measures: SSL encryption, access controls, and data minimization to protect your
              information.
            </p>

            <h3 className="text-lg font-semibold mt-6 mb-3">6. Contact</h3>
            <p>
              For any privacy concerns or data requests, reach out to us at:{" "}
              <a href="mailto:privacy@aiponatime.com" className="text-primary hover:underline">
                privacy@aiponatime.com
              </a>
            </p>
          </div>
        </Dialog.Panel>
