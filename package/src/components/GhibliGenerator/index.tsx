...
const GhibliGenerator = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
      try {
        ...
        const isRetryableError = lastError.message.includes("500")
  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div
        id="illustration-form"
        className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4 py-16"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Generate a beautiful Studio Ghibli-style illustration featuring your child as the hero of their own magical
            story!
          </p>
        </motion.div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {!puzzleLoaded && puzzleImages.length > 0 && (
                  <div className="text-center text-sm text-gray-500 dark:text-gray-400">
                    <div className="inline-flex items-center">
                      <div className="h-4 w-4 animate-spin rounded-full border-2 border-solid border-gray-400 border-t-transparent mr-2">
                      </div>
                ...
                {puzzleError && <p className="text-red-500 text-sm text-center">{puzzleError}</p>}
              ...
              <div className="text-center">
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 h-16 w-16 animate-ping rounded-full border-4 border-solid border-primary opacity-20">
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="mt-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3">
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      💫 Tip: Keep this page open - we're working hard to create the perfect illustration for{" "}
                      {formData.childName}!
                    </p>
                  </div>
                </div>
