      ...
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
        <div className="text-center">
          ...
          <p className="text-black/50 text-base font-normal max-w-3xl mx-auto">
            Join thousands of parents who are nurturing their children's imagination with personalized stories. Create
            magical reading moments that they'll cherish forever.
          </p>
        </div>
