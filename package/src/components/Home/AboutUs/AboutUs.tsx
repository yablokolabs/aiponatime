      ...
      >
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            {/* Decorative elements */}
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-yellow-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 -z-10">
            </div>
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 -z-10">
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-lg leading-relaxed">
              At AiPonATime, we believe every child deserves to be the hero of their own story. Our AI-powered platform
              creates personalized storybooks that make reading an exciting adventure for children of all ages.
            </p>
            <p className="text-gray-600 mb-8 text-lg leading-relaxed">
              With vibrant illustrations and engaging narratives, we help foster a love for reading that lasts a
              lifetime. Our stories are not just entertaining - they're educational tools that help children develop
