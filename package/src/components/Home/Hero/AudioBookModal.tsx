              ...
              {state.succeeded
                ...
                : (
                  <form ref={formRef} onSubmit={onSubmit} className="space-y-4">
                    <div>
                      <label htmlFor="childName" className="block text-sm font-medium text-gray-700 mb-1 text-left">
                        Child's Name:
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="childAge" className="block text-sm font-medium text-gray-700 mb-1 text-left">
                        Child's Age:
                      </label>
                      <select
                        id="childAge"
                    ...
                    <div>
                      <label htmlFor="parentEmail" className="block text-sm font-medium text-gray-700 mb-1 text-left">
                        Email:
                      </label>
                      <input
                        type="email"
