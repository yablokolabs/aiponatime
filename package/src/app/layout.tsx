...
export const metadata: Metadata = {
  ...
  description:
    "Create magical, personalized storybooks for children with AI. Spark their love of reading with custom stories where they are the hero!",
  ...
  openGraph: {
    ...
    description:
      "Create personalized, colorful storybooks that bring your child's imagination to life with AI-powered storytelling.",
