...
export const Aboutdata: { heading: string; imgSrc: string; paragraph: string; link: string }[] = [
  {
    ...
    paragraph: "Parents enter their child's name, age, and interests and complete payment — we'll handle the rest.",
    link: "Learn more",
  },
  {
  ...
  },
  {
    ...
    paragraph: "Receive a downloadable PDF or a beautifully printed paperback — the perfect gift beyond the screen.",
    link: "Learn more",
  },
];
...
export const Testimonials: { profession: string; comment: string; imgSrc: string; name: string; rating: number }[] = [
  ...
  },
  {
    name: "Tony M.",
    profession: "Parent",
    comment: "The AI created a story that felt truly unique to our family. It’s a keepsake we’ll treasure forever.",
  ...
  },
  {
    ...
    comment: "Seeing Mateo’s love of dinosaurs woven into his story was incredible. Highly recommend for any parent!",
